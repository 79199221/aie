...
@endsection
@section('content')
@include('multi::_nav', ['cate_title' => '首页', 'cate_title1' => '系统管理', 'cate_title2' => '栏目管理'])
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td>3</td>
					<td class="text-l">&nbsp;&nbsp;├&nbsp;二级栏目</td>
					<td class="f-14"><a title="编辑" href="javascript:;" onclick="system_category_edit('栏目编辑','{{url('admin/category/1/edit')}}','3','700','480')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
